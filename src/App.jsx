...
// View 1: Landing (countdown/hero/features). View 2: the Tool (map, address,
...
const TABS = [{ key: "district", label: "Find Your District" }, { key: "vote", label: "Vote on Bills" }];
          ...
          {TABS.map(t => (
            <button key={t.key} onClick={() => setTab(t.key)}
              style={{ fontFamily: serif, fontSize: 15, padding: "13px 18px", cursor: "pointer", border: "none",
                       background: "transparent", fontWeight: 700, color: tab === t.key ? C.crimson : C.muted,
