...
export const TUTORIAL_PAGES = {
  ...
  followthemoney: {
    ...
    items: [
      ...
      { label: "Medicaid", desc: "A national heat map of coverage share by state, drilling to every county and city or town the Census publishes. Data: American Community Survey 5 year estimates, table S2704. CMS publishes dollar spending at the state level only." },
      ...
      { label: "SNAP / Food Stamps", desc: "A national heat map of household participation share by state, with the same county and city drill down. Data: American Community Survey 5 year estimates, table S2201. It reports households receiving benefits; USDA publishes dollar payouts at the state level only." },
      { label: "Money Map", desc: "Six public money flows on one county level map: Medicare, Medicaid, SNAP, Social Security income, federal NGO awards, and campaign contributions. One program gives a heat map, two a blended overlap view, three or more side by side mini maps." },
